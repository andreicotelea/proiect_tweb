...
// node_modules/react-axios-provider-kit/dist/index.js
...
var AxiosContext = (0, import_react2.createContext)(void 0);
...
var defaultCreateClient = ({ baseURL }) => axios_default.create({ baseURL });
...
function AxiosProvider({
  ...
  createRefreshClient = ({ baseURL: baseURL2 }) => axios_default.create({
    baseURL: baseURL2,
  ...
  const [tokenState, setTokenState] = (0, import_react.useState)(() => storage.get());
  const tokenRef = (0, import_react.useRef)(tokenState);
  (0, import_react.useEffect)(() => {
    tokenRef.current = tokenState;
  }, [tokenState]);
  const setToken = (0, import_react.useCallback)(
    (t) => {
      storage.set(t);
      tokenRef.current = t;
      setTokenState(t);
  ...
  const client = (0, import_react.useMemo)(() => createMainClient({ baseURL }), [baseURL, createMainClient]);
  const refreshClient = (0, import_react.useMemo)(
    () => createRefreshClient({ baseURL }),
    [baseURL, createRefreshClient]
  );
  const refreshPromiseRef = (0, import_react.useRef)(null);
  const doNotify = (0, import_react.useCallback)(
    (payload) => {
      onNotify == null ? void 0 : onNotify(payload);
    },
    [onNotify]
  );
  const defaultShouldRefresh = (0, import_react.useCallback)((error, config) => {
    var _a;
  ...
  const failAuth = (0, import_react.useCallback)(
    (reason) => {
      var _a;
  ...
  const api = (0, import_react.useMemo)(() => exposeApi ? createApi(client, { onNotify }) : void 0, [client, exposeApi, onNotify]);
  ...
  return (0, import_jsx_runtime.jsx)(AxiosContext.Provider, { value, children });
}
function useAxios() {
...
//# sourceMappingURL=react-axios-provider-kit.js.map
